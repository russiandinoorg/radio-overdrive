...
export const generateMetadata = () => ({
  ...
  keywords: ['интернет-радио', 'новая музыка', 'топовые треки', 'рок', 'инди-музыка', 'андеграунд', 'радио через интернет бесплатно', 'радио с рок музыкой частота', 'самые популярные радио', 'радио с нормальной музыкой', 'ка бы слушать радио онлайн'],
  openGraph: {
